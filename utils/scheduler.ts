...
export async function setupNotificationChannel(): Promise<void> {
  ...
  try {
    ...
    logWarn('[scheduler] setupNotificationChannel failed:', error);
  }
}
...
export async function getScheduledNotificationCount(): Promise<number> {
  try {
    ...
    logWarn('[scheduler] getScheduledNotificationCount failed:', error);
    return 0;
  }
}
...
export async function cancelAllNotifications(): Promise<void> {
  try {
    ...
    logWarn('[scheduler] cancelAllNotifications failed:', error);
  }
}
