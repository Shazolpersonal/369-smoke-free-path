...
## 2026-07-03 - Proper Accessibility for Toasts
**Learning:** Added accessibility properties to Toast.tsx root element so screen readers can properly announce notifications.
**Action:** For React Native toast or alert notification components, always ensure they are properly announced to screen readers by adding accessible={true}, accessibilityRole="alert", accessibilityLiveRegion="polite", and a comprehensive accessibilityLabel to the root container.
