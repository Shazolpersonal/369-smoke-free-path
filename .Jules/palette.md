...
## 2026-06-29 - [Progress Ring Accessibility Context]
**Learning:** When implementing custom SVG-based progress rings or counters in React Native, the interactive progress elements are completely invisible to screen readers unless specifically marked up. Using visually apparent progress is insufficient. The outer container must act as a 'progressbar'.
