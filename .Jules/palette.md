...
## 2026-06-20 - Screen Reader Accessibility for Custom Toast Notifications
**Learning:** Custom animated notification components (like toasts) are not naturally announced by screen readers. They require explicit accessibility properties.
**Action:** For React Native toast or alert notification components, ensure they are properly announced to screen readers by adding accessible={true}, accessibilityRole="alert", accessibilityLiveRegion="polite", and a comprehensive accessibilityLabel containing the notification message to the root container.
