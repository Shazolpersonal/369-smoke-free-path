...
## 2026-06-25 - Accessible Toast Notifications
**Learning:** React Native toast or alert notification components should be properly announced to screen readers. This is achieved by adding `accessible={true}`, `accessibilityRole="alert"`, `accessibilityLiveRegion="polite"`, and a comprehensive `accessibilityLabel` to the root container.
**Action:** For React Native toast or alert notification components, ensure they are properly announced to screen readers by adding these accessibility properties to the root container.
