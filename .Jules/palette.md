...
## 2026-07-01 - Toast component accessibility
**Learning:** React Native toast/alert notifications are visually apparent but ignored by screen readers by default.
**Action:** For React Native toast or alert notification components, always ensure they are properly announced to screen readers by adding `accessible={true}`, `accessibilityRole="alert"`, `accessibilityLiveRegion="polite"`, and a comprehensive `accessibilityLabel` containing the notification message to the root container.
