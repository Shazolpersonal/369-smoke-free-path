...
export function Achievements() {
    ...
    // ⚡ Bolt: Memoize expensive array processing.
    // getAchievements runs heavy iterations. Memoizing this prevents ~50%
    // of unnecessary recalculations during unrelated local state changes (e.g., activeBadgeId).
