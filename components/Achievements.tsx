...
export function Achievements() {
    ...
    // ⚡ Bolt: Memoize achievements calculation to avoid unnecessary recalculations
    // and multiple object/array allocations on unrelated local state changes (e.g. activeBadgeId)
    const badges = useMemo(() => getAchievements(dailyProgress, trueStreak, totalElapsedDays), [dailyProgress, trueStreak, totalElapsedDays]);
