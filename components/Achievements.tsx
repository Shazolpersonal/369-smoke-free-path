...
export function Achievements() {
    ...
    const f = (weight: 'regular' | 'medium' | 'semibold' | 'bold') => getFontFamily(language, weight);
        ...
        // ⚡ Bolt: Memoize achievements calculation to avoid O(n) recalculations on every render
    // when local state (like activeBadgeId) changes. Prevents unnecessary CPU overhead.
