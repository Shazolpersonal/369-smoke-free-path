...
export function Achievements() {
    ...
    // ⚡ Bolt: Memoize expensive O(N) calculation to prevent unnecessary re-renders
    // of the achievements list when unrelated local state (like activeBadgeId) changes.
