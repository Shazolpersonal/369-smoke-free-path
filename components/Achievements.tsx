...
export function Achievements() {
    ...
    // ⚡ Bolt: Memoize the getAchievements result to prevent recalculating all badges on every render,
    // especially when tapping a badge updates the local activeBadgeId state.
