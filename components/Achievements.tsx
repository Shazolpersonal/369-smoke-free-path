...
export function Achievements() {
    ...
    // ⚡ Bolt: Memoize the calculation of badges to prevent unnecessary O(N) array
    // recalculations when unrelated local state (like activeBadgeId) changes and triggers re-renders.
