...
export function Achievements() {
    ...
    // ⚡ Bolt: Memoizing the getAchievements calculation prevents unnecessary and expensive
    // array recreations when the user clicks a badge and triggers the local activeBadgeId state change.
