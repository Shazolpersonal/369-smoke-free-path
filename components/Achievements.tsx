...
export function Achievements() {
    ...
    // ⚡ Bolt: Memoize the achievements calculation.
    // getAchievements is an O(N) operation over dailyProgress.
    // We only need to recalculate this when the underlying progress data changes,
    // not on unrelated local state changes (e.g., triggering a confetti animation on press).
