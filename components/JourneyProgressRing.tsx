...
export function JourneyProgressRing({
    ...
    return (
        <View style={[{ width: size, height: size }, styles.container]} accessible={true} accessibilityRole="progressbar" accessibilityValue={{ min: 0, max: totalDays, now: currentDay }} accessibilityLabel={`${t("dashboard.dayLabel") || "Day"} ${currentDay} / ${totalDays}`}>
