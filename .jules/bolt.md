...
## 2025-07-20 - Sequential Await Anti-pattern in Independent I/O Tasks
**Learning:** Sequentially awaiting independent I/O or system API calls (such as scheduling multiple notifications in a loop) creates cumulative latency, blocking execution unnecessarily.
**Action:** Always parallelize independent asynchronous operations using `Promise.all()` to eliminate cumulative delays and improve execution time.
