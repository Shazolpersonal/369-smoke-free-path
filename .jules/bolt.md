...
## 2026-07-05 - Limit useMemo Dependencies
**Learning:** Including unrelated state variables like dailyProgress in useMemo dependency arrays just to force dependent components to re-render causes performance degradation.
**Action:** Strictly limit dependency arrays in Context providers to variables actively used in the calculation.
