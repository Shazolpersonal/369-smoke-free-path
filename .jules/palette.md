...
## 2026-08-29 - Make Toast notifications accessible
**Learning:** Custom toast notifications need explicit ARIA/accessibility props in React Native to be read by screen readers.
**Action:** Always add accessible={true}, accessibilityRole="alert", accessibilityLiveRegion="polite", and accessibilityLabel to toast container components.
